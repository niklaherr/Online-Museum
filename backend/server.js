...
// ======= EDITORIAL LIST ROUTES ======= //

// Get all editorial lists
app.get("/editorial-lists", authenticateJWT, async (req, res) => {
    try {
...
app.get("/editorial-lists/:id", authenticateJWT, async (req, res) => {
    const { id } = req.params;
    try {
...
app.get("/items-search", authenticateJWT, async (req, res) => {
    ...
    try {
        ...
        // Make sure we're passing the parameter as a string
...
app.post("/editorial-lists", authenticateJWT, async (req, res) => {
    const { title, description, item_ids } = req.body;
    const userId = req.user.id;
...
app.put("/editorial-lists/:id", authenticateJWT, async (req, res) => {
...
app.delete("/editorial-lists/:id", authenticateJWT, async (req, res) => {
