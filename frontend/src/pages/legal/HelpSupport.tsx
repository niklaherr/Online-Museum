...
const HelpSupport = () => {
  ...
  // State to show loading indicator during submission
  const [isSubmitting, setIsSubmitting] = useState(false);
  // State to control Snake Game Easter Egg modal
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Submit the form to the backend service
  ...
  // Opens the Snake Game Easter Egg modal
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* User Manual Download (Easter Egg) */}
              <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                ...
                {/* Triggers Snake Game Easter Egg */}
                <button
